...
// slides for the stimuli
  ...
  slides.block1 = slide({
    ...
    present_handle : function(stim) {
	  ...
	  var radioSounds = "<th width='300px'><audio controls><source src=stimuli/" + this.stim.sound + " type='audio/wav'> Your browser does not support the audio element. </audio></th><th width='300x''><audio controls> <source src=stimuli/" + this.stim.sound + " type='audio/wav'> Your browser does not support the audio element.</audio></th>";
